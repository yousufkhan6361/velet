                        ...
                        foreach ($products as $key => $value):?>
                            <div class="col-md-3 col-sm-4 wow fadeInUp" data-wow-delay="1.2s">
                                <div class="proThumb chatBox">
                                    <a href="<?php echo g('base_url');?>merchandise/detail/<?php echo $value['product_slug'];?>"><img alt="" src="<?php echo get_image($value['product_image_path'], $value['product_image_thumb']);?>"></a>
                                    <div class="content1 chatName">
                                        <a href="<?php echo g('base_url');?>merchandise/detail/<?php echo $value['product_slug'];?>" class="proName"><?php echo $value['product_name'];?></a>
                                        <?php
                                        ...
                                        <a href="<?php echo g('base_url');?>merchandise/detail/<?php echo $value['product_slug'];?>" class="btnStyle1">Add to cart</a>
                                    </div>
                                </div>
                            </div>
                        <?php 
