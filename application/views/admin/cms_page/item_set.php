				...
				*/?>
	            ...
	            <div class="form-group ">
					<label for="" class="control-label col-md-2 "> 
		          	...
		          	<div class="col-md-3">
		            	<input type="text" value="100% Blacklight Disposable Electronic Hookah 6 MG" name="product[product_name]" slugify="#product-product_slug" id="product-product_name" class=" form-control ">
