                ...
                <tr style="margin:20px 0; float:left;height:86px;     background-color: #000000;" bgcolor="#68A13E">
                    ...
                    <td width="622">
                        ...
                        <table style="margin-top:20px;" width="580" cellspacing="0" cellpadding="0" border="0"
                            ...
                            <tr style="color:#fff;  ">
                                ...
                                <td width="251" align="left ">Order number : <b><?=$orderDetail['subscription_id'];?></b></td>
                    ...
                    <span style="font-size:18px;font-weight:bold">
                      ...
                      <span class="label label-danger">Approved</span>                    
                                ...
                                <td style="font-size: 22px;padding: 5px 0px;" id="total_sum" width="251" align="right">Total Amount: £<?=($orderDetail['subscription_amount'])?></td>
                        ...
                        <table style="margin-top:20px;" width="580" cellspacing="0" cellpadding="0" border="0"
                            ...
                            <tr style="color:#000;height:30px;">
                                ...
                                <td width="251" align="right">
                                    ...
                                    <?=$order_detail['packages_days']?> days
                            ...
                            <tr style="color:#000;height:30px;">
                                ...
                                <td width="251" align="right">
                                    ...
                                    £<?=$order_detail['subscription_amount']?>
