...
<!-- Breadcrumbs -->
<?php
$data['breadcrumb_title'] = 'Search (' . $this->session->userdata('search_keyword') . ')';
            ...
            <div class="col-md-4 col-xs-12 col-sm-6 hvr-sink">
                <div class="our-services-boxMain">
                    ...
                    <div class="our-services-box">
                        <h2><?=text_highlights($this->session->userdata('search_keyword'),$value['blog_title'], $case = false)?></h2>
                        <h3><?php echo $value['blog_category_name'];?></h3>
                        <h5> <a href="javascript:void(0)"><i class="fa fa-user" aria-hidden="true"></i> Admin</a> | <a href="javascript:void(0)"> <i class="fa fa-calendar" aria-hidden="true"></i> <?php echo date('d F m',strtotime($value['blog_createdon']));?></a> | <a href="javascript:void(0)"> <i class="fa fa-heart" aria-hidden="true"></i> 127</a></h5>
