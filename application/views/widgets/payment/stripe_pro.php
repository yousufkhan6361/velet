...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-info">
            <div class="panel-heading"><span><i class="glyphicon glyphicon-lock"></i></span> Pay with Credit Card - <?php echo price($amount);?></div>
            <div class="panel-body">
                <form action="<?php echo g('base_url');?>checkout/stripe-payment" method="post" id="payment-form">
                    ...
                    <br>
                    <br>
                    <input type="hidden" name="oid" value="<?php echo $custom;?>"/>
