<?
class Model_ads_socialmedialinks extends MY_Model {
    /**
     * TKD ads_socialmedialinks MODEL
     *
     * @package     ads_socialmedialinks Model
     * @author      Bilal farooqui (bilal_farooqui786@yahoo.com)
     * @version     2.0
     * @since       2017 / Amazingly corrupt models Corporation Inc.
     */

    protected $_table    = 'ads_socialmedialinks';
    ...
    public function delete_this($id)
    {
        ...
        $this->db->delete('ads_socialmedialinks');
        return true;
    }
    /********* IMAGE CONFIG END *************/
    ...
    */
    public function get_fields( $specific_field = "" )
    {
        ...
        $fields = array(
              ...
              'ads_socialmedialinks_id' => array(
                     'table'   => $this->_table,
                     'name'   => 'ads_socialmedialinks_id',
                     'label'   => 'id #',
                     'type'   => 'hidden',
                     'type_dt'   => 'text',
                     'attributes'   => array(),
              ...
              'ads_socialmedialinks_ads_id' => array(
                     'table'   => $this->_table,
                     'name'   => 'ads_socialmedialinks_ads_id',
                     'label'   => 'Product #',
                     'type'   => 'text',
                     'type_dt'   => 'text',
                     'attributes'   => array(),
              ...
              'ads_socialmedialinks' => array(
                     'table'   => $this->_table,
                     'name'   => 'ads_socialmedialinks',
                     'label'   => 'Product #',
                     'type'   => 'text',
                     'type_dt'   => 'text',
                     'attributes'   => array(),
              ...
              // 'ads_socialmedialinks_image' => array(
              //        'table'   => $this->_table,
              //        'name'   => 'ads_socialmedialinks_image',
              //        'label'   => 'Image',
              //        'name_path'   => 'ads_socialmedialinks_image_path',
              //        'upload_config'   => 'site_upload_ads_socialmedialinks',
              //        'thumb'   => array(
              //                           array(),
              //                       ),
              //        'type'   => 'fileupload',
