<?
class Model_ads_videolinks extends MY_Model {
    /**
     * TKD ads_videolinks MODEL
     *
     * @package     ads_videolinks Model
     * @author      Bilal farooqui (bilal_farooqui786@yahoo.com)
     * @version     2.0
     * @since       2017 / Amazingly corrupt models Corporation Inc.
     */

    protected $_table    = 'ads_videolinks';
    ...
    */
    public function get_fields( $specific_field = "" )
    {
        ...
        $fields = array(
              ...
              'ads_videolinks_id' => array(
                     'table'   => $this->_table,
                     'name'   => 'ads_videolinks_id',
                     'label'   => 'id #',
                     'type'   => 'hidden',
                     'type_dt'   => 'text',
                     'attributes'   => array(),
              ...
              'ads_videolinks_ads_id' => array(
                     'table'   => $this->_table,
                     'name'   => 'ads_videolinks_ads_id',
                     'label'   => 'Product #',
                     'type'   => 'text',
                     'type_dt'   => 'text',
                     'attributes'   => array(),
              ...
              // 'ads_videolinks_image' => array(
              //        'table'   => $this->_table,
              //        'name'   => 'ads_videolinks_image',
              //        'label'   => 'Image',
              //        'name_path'   => 'ads_videolinks_image_path',
              //        'upload_config'   => 'site_upload_ads_videolinks',
              //        'thumb'   => array(
              //                           array(),
              //                       ),
              //        'type'   => 'fileupload',
