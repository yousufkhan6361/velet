<?
class Model_ads_gallery extends MY_Model {
    /**
     * TKD ads_gallery MODEL
     *
     * @package     ads_gallery Model
     * @author      Bilal farooqui (bilal_farooqui786@yahoo.com)
     * @version     2.0
     * @since       2017 / Amazingly corrupt models Corporation Inc.
     */

    protected $_table    = 'ads_gallery';
    ...
    */
    public function get_fields( $specific_field = "" )
    {
        ...
        $fields = array(
              ...
              'ads_gallery_ads_id' => array(
                     'table'   => $this->_table,
                     'name'   => 'ads_gallery_ads_id',
                     'label'   => 'Product #',
                     'type'   => 'hidden',
                     'type_dt'   => 'text',
                     'attributes'   => array(),
              ...
              'ads_gallery_image' => array(
                     'table'   => $this->_table,
                     'name'   => 'ads_gallery_image',
                     'label'   => 'Image',
                     'name_path'   => 'ads_gallery_image_path',
                     'upload_config'   => 'site_upload_ads_gallery',
                     'thumb'   => array(
                                        array(),
                                    ),
                     'type'   => 'fileupload',
