    ...
    */
    public function get_fields( $specific_field = "" )
    {
        ...
        $fields = array(
              ...
              'ads_video_ads_id' => array(
                     'table'   => $this->_table,
                     'name'   => 'ads_video_ads_id',
                     'label'   => 'Product #',
                     'type'   => 'text',
                     'type_dt'   => 'text',
                     'attributes'   => array(),
              ...
              'ads_video_image' => array(
                     'table'   => $this->_table,
                     'name'   => 'ads_video_image',
                     'label'   => 'Image',
                     'name_path'   => 'ads_video_image_path',
                     'upload_config'   => 'site_upload_ads_video',
                     'thumb'   => array(
                                        array(),
                                    ),
                     'type'   => 'fileupload',
