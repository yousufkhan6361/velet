...
function getProperty($var){
  ...
  if($var == 'key') Return 'FAsTOgthgoWCYU3v';
	if($var == 'password') Return '0ltWx0op7CUCMAXzVta03CwYT';
	// if($var == 'parentkey') Return '77885445'; 
	if($var == 'parentkey') Return 'FAsTOgthgoWCYU3v';
	if($var == 'parentpassword') Return '0ltWx0op7CUCMAXzVta03CwYT';
	if($var == 'shipaccount') Return '716025632';

	if($var == 'billaccount') Return '716025632';
	if($var == 'dutyaccount') Return '716025632';
