...
class Manager
{
    ...
    {
        if ($id>0) {
            return (new Product($this->client, $id))->remove($id);
        }
     ...
     * @return mixed
     */
    public function uploadImage($id=0,$params=array())
    {
        if (array_filled($params)) {
            return (new Product($this->client, $id))->createImage($params);
        }
