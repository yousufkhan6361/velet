...
class Accessories extends MY_Controller {
    ...
    public function index($id='')
    {
        ...
        $data['brands'] = $this->get_brands(1);
        $data['styles'] = $this->get_style(1);
        // Get recent post
    ...
    private function _pagination()
    {
        ...
        $pagination["total_rows"] = $this->model_product->get_total_count_accessories();
        ...
        $vars["data"] = $this->model_product
            ->get_pagination_data_accessories($pagination["per_page"], (($page > 0)?($page-1):($page)) * $pagination["per_page"]);
