...
class Shop extends MY_Controller {
    ...
    public function index($id='')
    {
        ...
        $data['styles'] = $this->get_style();
        // Get recent post
        //$data['recent'] = $this->model_product->get_recent_post();
        // Set data
        $data['product_info'] = $this->_pagination($keyword);
        //exit;
        // Load view
    ...
    private function _pagination($keyword)
    {
        ...
        $pagination["total_rows"] = $this->model_product->get_total_count_search(array(), $keyword);
        ...
        $vars["data"] = $this->model_product
            ->get_pagination_data_accessories($pagination["per_page"], (($page > 0)?($page-1):($page)) * $pagination["per_page"], array(), $keyword);
