...
class Ads_inactive extends MY_Controller {
	...
	public function __construct() {
        ...
        $this->_list_data['ads_status'] = array( 
                                        STATUS_INACTIVE => "<span class=\"label label-success\">Inactive</span>" ,
                                        STATUS_ACTIVE =>  "<span class=\"label label-success\">Active</span>"
                                    );
